    ...
    <>
      ...
      <div className={`snm-panel${open ? " snm-open" : ""}`}>
        ...
        <div className="snm-header">
          ...
          <button className="snm-close" onClick={onClose}>
        ...
        <div className="snm-preview">
          <div className="snm-preview-icon">
            <Bell size={16} strokeWidth={1.8} />
          </div>
          <div className="snm-preview-body">
            <div className="snm-preview-title">
              {form.titleAr || "عنوان الإشعار"}
            </div>
            <div className="snm-preview-desc">
              {form.descAr || "وصف الإشعار سيظهر هنا..."}
            </div>
          </div>
        </div>
        ...
        <div className="snm-lang-tabs">
          <button
            className={`snm-lang-tab${tab === "ar" ? " active" : ""}`}
            onClick={() => setTab("ar")}
          >
            العربية
          </button>
          <button
            className={`snm-lang-tab${tab === "en" ? " active" : ""}`}
            onClick={() => setTab("en")}
          >
            ...
            <>
              <div className="snm-field">
                <label className="snm-label">
                  العنوان <span className="snm-required">*</span>
                </label>
                <input
                  className="inp"
                  value={form.titleAr}
              ...
              <div className="snm-field">
                ...
                <textarea
                  ...
                  placeholder="تفاصيل الإشعار بالعربي..."
        ...
        <div className="snm-footer">
          ...
          <button
            className="btn btn-p snm-send-btn"
            onClick={handleSubmit}
            disabled={send.isPending || !form.titleAr.trim()}
          >
