  ...
  return (
    <div className="page-fade">
          ...
          {locations.map((loc, i) => (
            <div
              ...
              style={{
                ...
                gap: 12,
                borderBottom:
                  i < locations.length - 1 ? "1px solid var(--line)" : "none",
              }}
            >
              <div style={{ flex: 1 }}>
              ...
              <span className="chip mut" style={{ fontSize: 11 }}>
                {loc.city?.name?.ar}
              </span>
              <span className="chip mut" style={{ fontSize: 11 }}>
                {loc.area?.name?.ar}
      ...
      <Modal
        ...
        title={modal === "create" ? "موقع جديد" : "تعديل الموقع"}
      >
        <div className="field-row">
          <div className="field">
            ...
            <input
              className="inp"
              value={form.ar}
              onChange={(e) => setForm((p) => ({ ...p, ar: e.target.value }))}
              placeholder="مثال: موقع المعادي الطبي"
            />
          </div>
          <div className="field">
            ...
            <input
              ...
              placeholder="e.g. Maadi Medical Location"
            />
          </div>
        </div>
        <div className="field-row">
