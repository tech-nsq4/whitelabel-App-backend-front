          ...
          {options.map((opt) => (
            <button
              ...
              style={{
                ...
                padding: "10px 14px",
                fontSize: 13,
                background: opt === value ? "var(--sand)" : "none",
                border: "none",
                cursor: "pointer",
                color: opt === value ? "var(--brand)" : "var(--ink)",
              ...
              onMouseLeave={(e) => {
                if (opt !== value) e.currentTarget.style.background = "none";
              }}
            >
              {opt}
              {opt === value && (
    ...
    <div className="page-fade">
      <div className="page-head">
        <div>
          ...
          <div className="sub">معلومات عيادتك الأساسية</div>
        </div>
      ...
      <div className="row c22">
        ...
        <div className="panel">
          <SectionHeader
            ...
            title="بيانات عيادتك"
            sub="الإعدادات الرسمية لملفك التعريفي"
          />
          <div style={{ padding: "20px 20px 4px" }}>
            <Field label="اسم عيادتك">
              <input
                className="inp"
        ...
        <div className="panel">
          <SectionHeader
            ...
            sub="إدارة مواعيد العيادة والحجوزات"
          />
          <div style={{ padding: "20px 20px 4px" }}>
            ...
            <Field label="مدة الزيارة الافتراضية">
              <CustomSelect
