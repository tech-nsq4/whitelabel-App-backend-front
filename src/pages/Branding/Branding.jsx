...
export default function Branding() {
  ...
  function applyPalette(p) {
    ...
    showToast(`تم اختيار لوحة ${p.label}`);
  }
    ...
    <div className="page-fade">
      <div className="page-head">
        <div>
          ...
          <div className="sub">تخصيص شعار وألوان عيادتك</div>
        </div>
      ...
      <div className="row c22">
          ...
          <div className="panel-head">
            <div>
              ...
              <div className="panel-sub">
                اختر مجموعة الألوان المناسبة لعيادتك
              </div>
            </div>
            {activePalette && (
                  ...
                  >
                    ...
                    <div
                      style={{
                        ...
                        fontWeight: 600,
                        textAlign: "center",
                        color: isActive ? "var(--brand)" : "var(--ink-70)",
                      }}
                    >
                      {p.label}
                    </div>
        ...
        <div className="panel">
          <div className="panel-head">
            <div className="panel-title">شعار عيادتك واسمها</div>
          </div>
          <div className="panel-body">
            <div className="field">
              <label className="field-label">اسم عيادتك (عربي)</label>
              <input
                className="inp"
                placeholder="اسم عيادتك (عربي)"
                value={nameAr}
                onChange={(e) => setNameAr(e.target.value)}
              />
            </div>
            <div className="field">
              <label className="field-label">اسم عيادتك (إنجليزي)</label>
              <input
                className="inp"
                dir="ltr"
            ...
            <div className="field">
              <label className="field-label">شعار عيادتك</label>
              ...
              {logo ? (
                ...
                >
                  ...
                  >
                    اسحب الشعار هنا أو انقر للاختيار
                  </div>
                  <div
                    style={{
                      fontSize: 11,
