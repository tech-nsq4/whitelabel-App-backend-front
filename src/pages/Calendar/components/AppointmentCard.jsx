export default function AppointmentCard({ patientName, doctorShortName, color, onClick, isSlot }) {
  if (isSlot) {
    return (
      <div style={{
        padding: '5px 10px',
        ...
        <span style={{ fontSize: 11.5, fontWeight: 600, color, fontFamily: 'monospace' }}>{patientName}</span>
        <span style={{ fontSize: 10, color: 'var(--ink-45)', marginRight: 'auto' }}>متاح</span>
      </div>
    )
  }
